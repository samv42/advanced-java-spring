...
public class ServiceAspect {
    ...
    public void logBeforeSaveAdvice(JoinPoint joinPoint){
        LOGGER.info("Before Save : " + joinPoint.getSignature());
    }
    @After("execution(* platform.codingnomads.co.aspectorientedprogramming.aop.service.StudentService.saveStudent())")
    public void logAfterSaveAdvice(JoinPoint joinPoint){
        LOGGER.info("After Save : " + joinPoint.getSignature());
    }
